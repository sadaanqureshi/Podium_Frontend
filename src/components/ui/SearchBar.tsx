...
export default function SearchBar({ placeholder, value, onChange }: {
  ...
  return (
    ...
    <div className="relative flex items-center w-full sm:max-w-full md:max-w-xl lg:max-w-lg border border-border-subtle rounded-2xl bg-card-bg focus-within:ring-2 focus-within:ring-accent-blue/50 h-[48px] shadow-sm">
