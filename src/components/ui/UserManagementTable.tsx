        ...
        <div className="overflow-x-auto rounded-[2rem]">
            <table className="w-full text-left border-separate border-spacing-0">
                <thead>
                    ...
                    <tr className="bg-table-header-bg text-table-header-text transition-colors duration-300">
                                    ...
                                    >
                                        ...
                                        {col.key === 'firstName' ? (
                                            <div className="flex items-center gap-4">
                                                <div className="w-11 h-11 rounded-2xl bg-app-bg border-2 border-card-bg shadow-sm flex items-center justify-center overflow-hidden flex-shrink-0 group-hover:scale-105 transition-transform duration-500">
                                    ...
                                    <td className="px-8 py-5 border-b border-border-subtle text-right">
                                        <div className="flex items-center justify-end gap-2 opacity-70 group-hover:opacity-100 transition-all transform translate-x-1 group-hover:translate-x-0">
                                            {visibleActions.includes('view') && (
                                                <button onClick={() => onView?.(item.id)} className="p-2.5 bg-sidebar-to/50 text-accent-blue rounded-xl hover:bg-accent-blue hover:text-white transition-all shadow-sm">
