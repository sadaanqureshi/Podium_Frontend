...
//                 <p className="text-text-muted font-black uppercase tracking-[0.2em] text-[10px]">Loading {type}s...</p>
//             </div>
//         );
//     }
...
//                             <th
//                                 key={index}
//                                 className={`px-8 py-6 first:rounded-tl-[0.5rem] font-black uppercase text-[10px] tracking-[0.2em] border-b border-border-subtle ${col.align === 'center' ? 'text-center' : col.align === 'right' ? 'text-right' : ''}`}
//                             >
//                                 {col.header}
//                             </th>
//                         ))}
//                         {showActionsColumn && (
//                             <th className="px-8 py-6 text-right rounded-tr-[0.5rem] font-black uppercase text-[10px] tracking-[0.2em] border-b border-border-subtle">
//                                 Control
//                             </th>
//                         )}
//                     </tr>
            ...
            <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-border-subtle">
                    {(data || []).length > 0 ? (
                        ...
                        <tr>
                            <td colSpan={columnConfig.length + 1} className="text-center py-16 text-text-muted text-sm">
