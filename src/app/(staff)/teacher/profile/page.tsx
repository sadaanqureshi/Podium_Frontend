...
const ProfilePage = () => {
    ...
    const handleSaveInfo = async (e: React.FormEvent) => {
        ...
        try {
            ...
            dispatch(
                setUser(withGoogleConnectedFlag(response.data || response, user))
            );
    ...
    const handleGoogleConnect = async () => {
        ...
        try {
            const returnUrl = `${window.location.origin}${GOOGLE_CALENDAR_SUCCESS_PATH}?next=${encodeURIComponent('/teacher/profile')}`;
                            ...
                            <div className="flex items-start justify-between gap-3">
                                <div>
                                    ...
                                    <p className="mt-2 text-xs text-text-muted leading-relaxed font-medium">
                                        Required for scheduling online live lectures with Meet links.
                                    </p>
                                </div>
                                <div
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 border-b border-border-subtle pb-6">
                                <div>
                                    ...
                                    <p className="text-xs text-text-muted font-medium mt-1">
                                        Keep your teaching identity up to date.
                                    </p>
                                </div>
                            </div>
